...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/navigation.js [app-ssr] (ecmascript)"); // hooks to read URL params and navigate
...
async function exchangeCodeForJWT(code) {
    // async means this function works with elements that require time and always returns a Promise
    const tokenEndpoint = "https://ai-coach-user-pool-login.auth.eu-west-2.amazoncognito.com/oauth2/token";
    const body = new URLSearchParams({
        grant_type: "authorization_code",
        client_id: process.env.NEXT_PUBLIC_COGNITO_CLIENT_ID || "7otnem48lmjgq7uur1ervv5s9l",
        code,
...
function CallbackPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        // ---------------- ADD ----------------
        exchangeCodeForJWT(code).then((tokens)=>{
...
} // state is use to link two moments, when login starts and when cognito response returns
 // callback is a public page and anyone can open it, and without a state the app can excahnge any code for a JWT
 // I need to make sure that the MY login request is alligned with the callback im using
 // when I do login app generates state, saves it  in the browser and sends it to cosgnito with the request
 // when cognito goes back to callback bring with itself code + state, in this way it's possible to check if it is the same as the one that was saved originally
 // if not another user could send me a call back link with its code, and opening it I could login in its profile
 // every code is linked with a user, but I want to make sure, using state, that the code is the right response to my login request. having a code is enough to login in its corresponding profile, with state I put a further obstacle, that does not allow to authenticate in another user profile just having its code.
}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9c203ca4._.js.map