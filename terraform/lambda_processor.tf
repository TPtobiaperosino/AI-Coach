...
resource "aws_lambda_function" "processor" {
  ...
  filename         = "../lambda_functions/processor.zip"                   # this says to terraform --> when you create/update the lambda use this file as code/function
  source_code_hash = filebase64sha256("../lambda_functions/processor.zip") # file() reads file byte per byte, sha256 produces the hash in bytes, base64 transforms bytes in string.
